 ...
 * */
public class LHScrollView extends HorizontalScrollView {
	ScrollViewObserver mScrollViewObserver = new ScrollViewObserver();

	public LHScrollView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		// TODO Auto-generated constructor stub
	}

	public LHScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public LHScrollView(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		Log.i("pdwy","LHScrollView onTouchEvent");
