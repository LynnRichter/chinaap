	...
	private void UIFactory()
	{
		...
		searchView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setClass(PriceActivity.this, PriceSearchResultAcitivity.class);
	...
	private void startLoad()
	{
		Runnable dataRunnable = new Runnable() {
			...
			public void run() {
				...
				.append("userid=").append(JSONHelpler.getString(getApplicationContext(), getString(R.string.key_username))).append("&")
